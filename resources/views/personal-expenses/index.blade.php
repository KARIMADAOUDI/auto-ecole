                                ...
                                @forelse($expenses as $expense)
                                    <tr>
                                        <td class="px-6 py-4 whitespace-nowrap">
                                            {{ $expense->instructor->first_name }} {{ $expense->instructor->last_name }}
                                        </td>
                                        <td class="px-6 py-4 whitespace-nowrap">
                                        ...
                                        <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium flex items-center space-x-2">
                                            <a href="{{ route('personal-expenses.edit', $expense) }}" class="inline-flex items-center px-2 py-1 bg-yellow-500 text-white rounded hover:bg-yellow-600" title="Modifier">
                                                <i class="bi bi-pencil-square mr-1"></i> Modifier
                                            </a>
                                            <form action="{{ route('personal-expenses.destroy', $expense) }}" method="POST" class="inline">
                                                @csrf
                                                @method('DELETE')
